.PHONY: build test test-e2e lint fmt coverage vendor deadcode audit install setup-hooks clean check-versions help
...
audit: ## run complexity analysis (informational)
